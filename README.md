...
import HeaderComponent from '../../../Common/HeaderComponent';  // Import the HeaderComponent
...
const JobDetails: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      >
        {({ values, handleBlur, errors, touched, setFieldValue, validateForm }) => (
          <>
            <HeaderComponent 
              ...
              onBack={() => {}}
              step={1}
              validateDetails={() => validationSchema.validate(values)}
              validateParams={() => Promise.resolve()}  // Assuming there are no params to validate in this case
              validateTargetParams={() => Promise.resolve()}  // Assuming there are no target params to validate in this case
              compName={t('job_CompName')}
